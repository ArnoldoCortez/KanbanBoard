...
// Add new element to column list, reset textbox
...
// Upade arrays from drag and drop items
...
// Functionality when item is drag
function drag(e) {
...
function dragEnter(column) {
  ...
  if (currentColumn !== undefined && currentColumn !== column){
